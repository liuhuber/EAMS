...
function show_requireform($sn = "")
{
  ...
  $possible_solutions = str_replace("\r\n","\n",$possible_solutions);
  $possible_solutions = str_replace($eols,"<br>",$possible_solutions)."\n";
